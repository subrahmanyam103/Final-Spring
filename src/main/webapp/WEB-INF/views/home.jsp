...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/assets/homepagestyle.css">
<link rel="stylesheet"
			...
			<div class="row cards">
				<div class="col-md-4 d-flex justify-content-center">
					<div class="card" style="width: 20rem;">
						<img src="${pageContext.request.contextPath}/resources/assets/medicine.jpg" class="card-img-top icons"
				...
				<div class="col-md-4 d-flex justify-content-center">
					<div class="card" style="width: 20rem;">
						<img src="${pageContext.request.contextPath}/resources/assets/medicine-delivery.jpg"
				...
				<div class="col-md-4 d-flex justify-content-center">
					<div class="card" style="width: 20rem;">
						<img src="${pageContext.request.contextPath}/resources/assets/trust.jpg" class="card-img-top icons"
							alt="Service Three" />
						<div class="card-body">
