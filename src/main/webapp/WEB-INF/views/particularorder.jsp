<%@page import="com.pharmacy.model.ParticularOrderBean"%>
...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/assets/particularorder.component.css">
<link rel="stylesheet"
...
window.onload = function () {
	...
	if (session.getAttribute("username") == null || token == null) {
		...
		List<ParticularOrderBean> products = (List<ParticularOrderBean>)request.getAttribute("products");
							...
							<div class="mt-4">
								...
								<div>
									...
									<form class="form-inline"
										action="${pageContext.request.contextPath}/UpdateOrder/<%=order.getOrderId()%>/<%=order.isMedicine()
										%>"
										method="POST">
